...
| セクション | 内容 | 時間 |
|-----------|------|------|
| [このファイル](./README.md) | ガイド概要・目次 | 10 分 |

### **Part 1: Amazon KDP の基礎知識**
| セクション | 内容 | 時間 | ファイル |
|-----------|------|------|---------|
| [01. KDP 概要](./01-overview.md) | KDP とは何か、何ができるか | 20 分 | `01-overview.md` |
| [02. アカウント作成](./02-account-setup.md) | AWS / KDP アカウントの作成・設定 | 15 分 | `02-account-setup.md` |

### **Part 2: 原稿準備と入稿**
| セクション | 内容 | 時間 | ファイル |
|-----------|------|------|---------|
| [03. 原稿準備](./03-prepare-manuscript.md) | AZW3 ファイル生成・チェック | 30 分 | `03-prepare-manuscript.md` |
| [04. アップロード・出版](./04-upload-publish.md) | KDP へのアップロード・公開手順 | 30 分 | `04-upload-publish.md` |

### **Part 3: 詳細設定と販売戦略**
| セクション | 内容 | 時間 | ファイル |
|-----------|------|------|---------|
| [05. メタデータと価格](./05-metadata-and-pricing.md) | カテゴリ・キーワード・価格設定 | 25 分 | `05-metadata-and-pricing.md` |
| [06. Kindle Unlimited](./06-kindle-unlimited.md) | 読放題プログラムの仕組みと活用 | 20 分 | `06-kindle-unlimited.md` |

### **Part 4: 販売促進とトラブルシューティング**
| セクション | 内容 | 時間 | ファイル |
|-----------|------|------|---------|
| [07. マーケティング](./07-marketing-tips.md) | SNS 宣伝・レビュー獲得・セール戦略 | 20 分 | `07-marketing-tips.md` |
| [08. FAQ・トラブル対応](./08-troubleshooting-faq.md) | よくある質問・エラー対応 | 20 分 | `08-troubleshooting-faq.md` |
