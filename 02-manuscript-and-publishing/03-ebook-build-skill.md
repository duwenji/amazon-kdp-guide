...
| ファイル | 説明 |
|---|---|
| [SKILL.md](./../.github/skills/ebook-build/SKILL.md) | Copilot 向けスキル定義（パラメータ仕様） |
| [docs/README.md](./../.github/skills/ebook-build/docs/README.md) | 実行ガイド（詳細版） |
| [VALIDATION_CHECKLIST.md](./../.github/skills/ebook-build/VALIDATION_CHECKLIST.md) | 検証チェックリスト |
| [KINDLE-COMPATIBILITY-CHECKLIST.md](./../.github/skills/ebook-build/docs/KINDLE-COMPATIBILITY-CHECKLIST.md) | Kindle 互換性チェック |
| [invoke-ebook-build.ps1](./../.github/skills/ebook-build/scripts/invoke-ebook-build.ps1) | ビルド実行スクリプト（エントリポイント） |
